...
model_saved = model.fit(training_set,
        epochs=10,
...
test_image=image.load_img(r'C:\Users\gubek\Downloads\FaceMaskDetector-master\FaceMaskDetector-master\test\with_mask\1-with-mask.jpg',
